...
<Warning>
  It's important to instruct the model to use JSON in the `prompt`. Otherwise,
  the model may generate large amounts whitespace.
</Warning>
...
<Note>This endpoint has been superseded by `/api/embed`</Note>
